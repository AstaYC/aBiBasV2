...
<body>
    ...
    <main>
      ...
      <br><br>
        ...
        <div class="col-sm-7">
          <a href="" class="btn btn-primary" data-toggle="modal" data-target="#addCategorieModal"><i class="material-icons">&#xE147;</i> <span>Add New Categorie</span></a>
          <br><br>				
        </div>
        {{-- add modal --}}
         ...
         @foreach($categories as $categorie)
          <div class="modal" id="updateCategoryModal{{$categorie->id}}">
            <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h4 class="modal-title">Update Categorie "{{$categorie->nom}}"</h4>
                      <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
                    <div class="modal-body">
         ...
         <div class="modal" id="deleteCategoryModal{{$categorie->id}}">										
           <div class="modal-dialog">
						  <div class="modal-content">
						  	<!-- Modal Header -->
						  	<div class="modal-header">
						  		<h4 class="modal-title">Delete Categorie "{{$categorie->nom}}"</h4>
						  		<button type="button" class="close" data-dismiss="modal">&times;</button>
						  	</div>
						  	<!-- Modal Body -->
						  	<div class="modal-body">
